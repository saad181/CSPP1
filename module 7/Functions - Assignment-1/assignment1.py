...
def payingdebt(balance, annual_intrest_rate, monthly_payment_rate):
    '''this function calculates the credit card balance '''
    for _ in range(12):
        monthly_intrest_rate = (annual_intrest_rate)/12.0
...
def main():
    ...
    print(payingdebt(data[0], data[1], data[2]))
